(function (global, factory) {
  ...
  (global = global || self, global.j6t = factory(global.$));
}(this, (function (_jQuery) { 'use strict';

  var _jQuery__default = 'default' in _jQuery ? _jQuery['default'] : _jQuery;
    ...
    if (isObject(target) && isObject(source)) {
      for (var key in source) {
        if (isObject(source[key])) {
          if (!target[key]) {
            jq.extend(target, _defineProperty({}, key, {}));
          }

          deepAssign(target[key], source[key]);
        } else {
          jq.extend(target, _defineProperty({}, key, source[key]));
        }
      }
    }
  ...
  */
  ...
  function urlEncode$1(literals) {
    ...
    return tagHelper(literals, expressions, function (x) {
      return urlEncodeToString(typeof x == 'string' ? x.trim() : x);
    }, function (x) {
      return urlEncodeToString(x);
    });
  }

  function urlDecode$1(literals) {
    ...
    return tagHelper(literals, expressions, function (x) {
      return urlDecodeToString(x);
    }, function (x) {
      return urlDecodeToString(x);
    });
  }

  function reverse$1(literals) {
  ...
  function htmlEncode$1(literals) {
    ...
    return tagHelper(literals, expressions, function (x) {
      ...
      return htmlEncodeToString(x);
    });
  }

  function htmlDecode$1(literals) {
  ...
  var isValidTag = function isValidTag(tag) {
    return isSomeString(tag) && /^[a-zA-Z][a-zA-Z0-9-_]*$/.test(tag);
  };

  var isValidAttributeName = function isValidAttributeName(attr) {
    return isSomeString(attr) && /^[a-zA-Z][a-zA-Z0-9-_]*$/.test(attr);
  };

  var isValudURI = function isValudURI(uri) {
    return isSomeString(uri) && /^(http|https):\/\/[a-zA-Z0-9-_\.]$/.test(uri);
  };

  var isValidEvent = function isValidEvent(e) {
    return isSomeString(e) && /^\w+$/.test(e);
  };

  var isValidDomId = function isValidDomId(e) {
    return isSomeString(e) && /^\w(\w|-|:|\.)*$/.test(e);
  };

  var isValidId = function isValidId(e) {
    return isSomeString(e) && /^[a-zA-Z]\w*$/.test(e);
  };
  ...
  function () {
    ...
    _createClass(BaseLogger, [{
      ...
      value: function _logInternal(log) {
        NotImplementedException("".concat(this.constructor.name, "._logInternal()"));
      }
    }, {
      key: "log",
      value: function log() {
  ...
  function (_StoreLogger) {
    ...
    function StringLogger(props) {
      ...
      if (!isSomeString(_this3.logFormat)) {
        _this3.logFormat = '%date: %data\n';
      }

      if (!isSomeString(_this3.replacer)) {
        _this3.replacer = '\t';
      }

      if (!isSomeString(_this3.space)) {
        _this3.space = '   ';
      }
  ...
  function (_BaseLogger4) {
    ...
    function DomLogger(props) {
      ...
      if (!isSomeString(_this5.target)) {
        _this5.target = '#logs';
      }

      if (!isSomeString(_this5.lineBreak)) {
        _this5.lineBreak = '<br/>\n';
      }

      if (!isSomeString(_this5.replacer)) {
        _this5.replacer = '\t';
      }

      if (!isSomeString(_this5.space)) {
        _this5.space = '   ';
      }

      if (!jq.isFunction(_this5.onLog)) {
        _this5.onLog = function () {};
      }

      _this5._target = jq(_this5.target);
      return _this5;
    }
  ...
  */
  ...
  function () {
    ...
    _createClass(j6tIdProvider, [{
      ...
      value: function generate(id) {
        NotImplementedException("".concat(this.constructor.name, ".generate()"));
      }
    }, {
      key: "getState",
  ...
  function (_j6tIdProvider) {
    ...
    function j6tUniversalIdProvider(props) {
      ...
      jq.extend(_assertThisInitialized(_this), {
        counter: 0,
        preservedCounter: 0,
        idPrefix: '_el_'
      }, _props);
  ...
  function () {
    function Component(props) {
      ...
      this.props = jq.extend({}, isSomeObject(props) ? props : {
        arg: props
      });
      ...
      var __props = _objectSpread2({}, props);
        ...
        function _evalName(args) {
          ...
          */
          ...
          do {
            ...
            props = isSomeObject(args.arg) ? _objectSpread2({}, args.arg) : {
              arg: args.arg
            };
            ...
            if (tags$2.indexOf(args.name) >= 0) {
              if (args.directive == '^') {
                ...
                try {
                  obj = new BaseTag(_objectSpread2({
                    tagName: args.name
                  }, props));
                } catch (e) {
  ...
  */
  ...
  function () {
    ...
    _createClass(BaseElement, [{
      key: "render",
      value: function render() {
        NotImplementedException("".concat(this.constructor.name, ".render()"));
      }
    }]);
  ...
  function (_Component2) {
    ...
    function BaseTag(props) {
      ...
      */
      ...
      _this4.selfClose = isBool(_this4.props.selfClose) ? _this4.props.selfClose : false; //this.lastId = this.id; we don't support me.lastId any more because it is problematic
    ...
    _createClass(BaseTag, [{
      ...
      value: function getAttributes() {
        ...
        jq.each(this.props, function (prop) {
  ...
  function (_BaseTag) {
    ...
    function stylesTag(props) {
      ...
      var _props = isSomeObject(props) ? props : {};
  ...
  function (_BaseTag2) {
    ...
    function linkTag(props) {
      ...
      _this5.props.href = isSomeString(_this5.props.href) ? _this5.props.href : '';
      _this5.props.rel = isSomeString(_this5.props.rel) ? _this5.props.rel : '';
      _this5.props.type = isSomeString(_this5.props.type) ? _this5.props.type : '';

      if (left(_this5.props.href, 4).toLowerCase() == '.css') {
        if (isEmpty(_this5.props.rel)) {
          _this5.props.rel = 'stylesheet';
        }

        if (isEmpty(_this5.props.type)) {
  ...
  function (_BaseTag3) {
    ...
    function scriptTag(props) {
      ...
      _this6.props.src = isSomeString(_this6.props.src) ? _this6.props.src : '';
      _this6.props.type = isSomeString(_this6.props.type) ? _this6.props.type : '';

      if (left(_this6.props.src, 3).toLowerCase() == '.js') {
        if (isEmpty(_this6.props.type)) {
          _this6.props.type = 'text/javascript';
        }
      } else if (left(_this6.props.src, 5).toLowerCase() == '.json') {
        if (isEmpty(_this6.props.type)) {
  ...
  function (_BaseAttribute3) {
    ...
    function idAttribute(props) {
      ...
      if (isEmpty(_this14.attributeValue)) {
        _this14.attributeValue = '';
      }

      if (isSomeObject(_this14.container)) {
  ...
  function (_BaseElement2) {
    ...
    function bindElement(props) {
      ...
      */
      ...
      _this18.event = (isSomeString(_this18.event) ? _this18.event : '').toLowerCase();
    ...
    _createClass(bindElement, [{
      ...
      value: function render() {
        ...
        this.logger.debug("event: '".concat(this.event, "', target: '").concat(this.target, "', container: '").concat(isSomeObject(this.container) ? 'ok' : 'error', "'"));

        if (isValidEvent(this.event) && isSomeString(this.target) && isFunction(this.handler) && isSomeObject(this.container) && isArray(this.container._events)) {
